...
// import { Users, UserCheck, Calendar, CheckCircle, XCircle, Clock, Package } from 'lucide-react';

export function AdminStats() {
  return (
    <>
      <h1 className="text-3xl font-bold">Admin</h1>
      <h2 className="text-3xl font-bold text-red-400 text-center">Welcome to Talk Master</h2>
